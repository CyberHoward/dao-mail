...
impl DkimAuthConfig {
    ...
    pub fn verify_email_auth(&self, email_auth: &EmailAuthDetails) -> Result<(), AuthenticatorError> {
        // TODO: implement verification logic here
        println!("Verifying email auth for domain: {} on behalf of sender: {}", self.domain, email_auth.get_sender()?);
