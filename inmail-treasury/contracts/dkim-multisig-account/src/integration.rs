...
use cosmwasm_std::{wasm_execute, Coin, Timestamp, Uint128};
...
use osmosis_test_tube::{
    ...
    osmosis_std::types::cosmos::bank::v1beta1::MsgSend, Account, ExecuteResponse, FeeSetting,
    Module, OsmosisTestApp, Runner, RunnerExecuteResult, SigningAccount, Wasm,
};
...
use crate::{
    ...
    test_helper::authenticator_setup::{
        ...
        add_email_auth_authenticator,
        email_auth_instantiate,
...
fn test_happy_path_integration() {
    ...
    let spend_limit_auth_id =
        add_email_auth_authenticator(&app, &acc_1, &authenticator_addr, &params);
